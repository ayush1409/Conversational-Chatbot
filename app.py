## RAG Chatbot with document history
...
# setup streamlit app
st.title("Conversational Chatbot with PDF uploads and Chat history")
...
if api_key:
    ...
    if uploaded_files:
        ...
        history_aware_retiever = create_history_aware_retriever(llm, retriever, contextualize_q_prompt)
        ...
        rag_chain = create_retrieval_chain(history_aware_retiever, question_answering_chain)
    ...
    st.warning("Please enter the Groq key")